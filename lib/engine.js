...
function editBoardInSource(sourceText, boardId, newBoard) {
  ...
  // Find extent: board line + continuation lines (indented)
  let endIdx = startIdx;
  ...
  const newLines = reconstructBoardLine(newBoard).split('\n');
